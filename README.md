...
The panel needs width that only exists above 1080 px; below that the elevation rides in the day's chip row instead. It lives inside the `<summary>`, so it reads with the day collapsed and clicking it still toggles the day.
